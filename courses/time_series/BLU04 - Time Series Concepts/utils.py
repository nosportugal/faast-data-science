...
def measure_error(measurement, corect_measure):
    ...
    print("We measured %0.2f Km, which is wrong by %0.2f Km" % (measurement, error))
...
def plot_number_of_tries(series):
    ...
    plt.title(
        "Expanding window of the measures of the radius of the Earth (+/- 10 Km in green)"
    )
...
def plot_seasonality_for_airlines(normalize=False):
    ...
    plt.xlabel("Month")
    plt.ylabel("Thousands of US passengers")
